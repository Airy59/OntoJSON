        ...
        return {
            "rules": {
                ...
                "ontology_to_document": {
                    "enabled": True,
                    "options": {
                        # Schema metadata options (all optional, use None to use defaults)
                        # "$id": None,  # Default: http://example.org/<title>.json
                        # "title": None,  # Default: ontology title/label or URI fragment
                        # "$comment": None,  # Default: "generated by OntoJSON from <ontology URI>"
                        "include_imports": True  # Include imports in $comment
                    }
                },
